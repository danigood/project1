...
Now I can focus on the viral load data. I'm going to separate the Atc and B6 data into two different tables, using the same method I did to remove the GAPDH data.
