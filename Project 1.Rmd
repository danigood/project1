...
```{r echo=FALSE}
#plot the data
compiled <- rbind(avg_b6_celldata,avg_atc_celldata)
data <- tapply(compiled$RQ, list(compiled$strain,compiled$time_point), sum)
barplot(data,beside=T,col=c("blue","orange")
,main="Cell Fraction Data",xlab="Time Point",ylab="Fold Change Over C57BL/6")
```
